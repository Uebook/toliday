...
exports.FinanceModule = FinanceModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([ledger_entry_entity_1.LedgerEntry, invoice_entity_1.Invoice, payout_request_entity_1.PayoutRequest])],
        controllers: [finance_controller_1.FinanceController],
        providers: [finance_service_1.FinanceService],
        exports: [typeorm_1.TypeOrmModule, finance_service_1.FinanceService],
    })
], FinanceModule);
