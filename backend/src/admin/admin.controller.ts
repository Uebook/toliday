...
export class AdminController {
       ...
       updatePromotionStatus(@Param('id') id: string, @Body('isVerified') isVerified: boolean) {
       ...
       updateHotelStatus(@Param('id') id: string, @Body('status') status: HotelStatus) {
       ...
       updateTourPartnerStatus(@Param('id') id: string, @Body('status') status: TourPartnerStatus) {
       ...
       updateBusVendorStatus(@Param('id') id: string, @Body('status') status: BusVendorStatus) {
       ...
       updateCabVendorVerification(@Param('id') id: string, @Body('isVerified') isVerified: boolean) {
