...
export class FinanceController {
  ...
  private extractVendorContext(req: any) {
    if (req.user.hotelId)
      return { vendorId: req.user.hotelId, vertical: VerticalType.HOTEL };
    ...
    if (req.user.busVendorId)
      return { vendorId: req.user.busVendorId, vertical: VerticalType.BUS };
    if (req.user.cabVendorId)
      return { vendorId: req.user.cabVendorId, vertical: VerticalType.CAB };
