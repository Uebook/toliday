...
export class Staff {
       ...
       @ManyToOne(() => Hotel, (hotel) => hotel.staffs, { onDelete: 'CASCADE', nullable: true })
       ...
       @ManyToOne(() => TourPartner, (partner) => partner.staffs, { onDelete: 'CASCADE', nullable: true })
       ...
       @ManyToOne(() => BusVendor, (vendor) => vendor.staffs, { onDelete: 'CASCADE', nullable: true })
