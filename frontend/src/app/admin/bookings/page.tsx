...
export default function MasterBookingsPage() {
       ...
       const getVerticalDetails = (booking: any) => {
              ...
              return { type: 'UNKNOWN', icon: Calendar, color: 'text-muted-foreground', bg: 'bg-slate-50', name: 'Unknown Vendor' };
       };
                     ...
                     render: (booking: any) => {
                            ...
                            return (
                                   <div className="flex items-center gap-3">
                                          ...
                                          <div>
                                                 <div className="text-[10px] font-black uppercase tracking-widest text-muted-foreground">{details.type}</div>
       ...
       const headerAction = (
              <button className="px-6 py-3 bg-indigo-600 hover:bg-indigo-500 text-foreground rounded-2xl font-black text-[10px] uppercase tracking-widest flex items-center gap-2 transition-all shadow-xl shadow-indigo-600/20 active:scale-95 group">
       ...
       return (
              <div className="p-6 md:p-8 space-y-6 md:space-y-8 animate-fadeIn max-w-[1600px] mx-auto min-h-full">
                     <Topbar title="Master Bookings List" subtitle="Global oversight of all reservations across all verticals" />
