...
export default function GlobalLedgerPage() {
       ...
       return (
              <div className="p-6 md:p-8 space-y-6 md:space-y-8 animate-fadeIn max-w-[1600px] mx-auto min-h-full">
                     <Topbar title="Global Transactions" subtitle="Master ledger tracking all incoming revenue and vendor payouts" />
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="ios-platter p-6 rounded-[24px] border border-border/10 shadow-[0_4px_20px_rgba(0,0,0,0.01)] transition-transform hover:scale-[1.03]">
                                   <div className="p-8 relative z-10">
                                          ...
                                          <div className="text-4xl font-black text-foreground mb-4">₹1.24M</div>
                                   </div>
                            </div>
                            <div className="ios-platter p-6 rounded-[24px] border border-border/10 shadow-[0_4px_20px_rgba(0,0,0,0.01)] transition-transform hover:scale-[1.03]">
                                   <div className="p-8 relative z-10">
                                          <div className="text-[10px] font-black text-rose-500 uppercase tracking-widest mb-2">Pending Vendor Payouts</div>
                                          <div className="text-4xl font-black text-foreground mb-4">₹42,500</div>
                                   </div>
                            </div>
