...
export default function PackagesReviewsPage() {
       ...
       return (
              <div className="p-6 md:p-8 space-y-6 md:space-y-8 animate-fadeIn max-w-[1600px] mx-auto min-h-full">
                     <Topbar title="Reviews & CX Moderation" subtitle="Monitor and moderate guest feedback across all tour partners" />
                            ...
                            <div className="bg-background/40 backdrop-blur-md border-b border-border/10 p-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                                   ...
                                   <div className="relative">
                                          ...
                                          <input
                                                 ...
                                                 className="pl-10 pr-4 py-3 bg-black/5 dark:bg-white/5 border border-transparent text-foreground rounded-2xl text-sm font-bold focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none w-full md:w-80 transition-all"
                                          />
                                   </div>
                            </div>
                                   ...
                                   {isLoading ? (
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-8">
                                          {filteredReviews.map((review: any) => (
                                                 <div key={review.id} className="relative overflow-hidden group hover:border-emerald-200 transition-all shadow-sm hover:shadow-xl ios-platter border-border/10 rounded-[28px]">
                                                        <div className="p-6">
