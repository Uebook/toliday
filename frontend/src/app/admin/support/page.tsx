              ...
              <div className="p-8 lg:p-12 animate-fadeIn space-y-8">
                     <header className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                            <div>
                                   ...
                                   <h1 className="text-4xl font-black text-slate-900 tracking-tight">Global Support Desk</h1>
                                   <p className="text-slate-400 font-bold mt-2">Centralized helpdesk for all verticals</p>
                            </div>
                     </header>
