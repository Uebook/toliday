      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-20">
          <motion.span 
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-blue-50 text-indigo-700 text-xs font-extrabold uppercase tracking-widest mb-4"
          >
          ...
          <motion.h2 
            ...
            className="text-4xl md:text-5xl font-extrabold text-zinc-900 tracking-tight mb-6 leading-tight"
          >
          ...
          {features.map((feat, idx) => {
            ...
            return (
              <motion.div
                ...
                className="relative bg-white rounded-lg p-8 border border-zinc-100/80 hover:border-zinc-200/80 shadow-sm hover:shadow-md transition-all duration-300 group flex flex-col items-start text-left cursor-pointer"
              >
                {/* Icon Container with beautiful gradient background glow on hover */}
                <div className="relative mb-8 w-14 h-14 rounded-xl bg-zinc-50 flex items-center justify-center transition-all duration-300 group-hover:scale-110 group-hover:shadow-lg">
                ...
                <h3 className="text-xl font-bold text-zinc-900 mb-3 transition-colors group-hover:text-blue-600">
                  {feat.title}
                </h3>
